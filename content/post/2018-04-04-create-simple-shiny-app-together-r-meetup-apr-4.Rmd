---
title: Create simple Shiny app together! (R meetup Apr 4)
author: Ben Toh
date: '2018-04-04'
...
`app.R` script in each subfolder is non-functional, and we'll add codes in them together during the presentation to make them work. `appFull.R` is the fully functional copy.
